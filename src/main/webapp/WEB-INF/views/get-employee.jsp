...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/css/get-employee.css">
</head>
<body>
    <nav class="navbar">
    ...
    <main class="employee-section">
        <div class="page-header">
            <div>
                ...
                <p>View and manage all employees registered in your workforce database.</p>
            </div>
                ...
                <table class="employee-table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <c:choose>
                                    <c:when test="${e.status eq 'Active'}"><span class="status active">Active</span></c:when>
                                    <c:when test="${e.status eq 'Inactive'}"><span class="status inactive">Inactive</span></c:when>
                                    <c:otherwise><span class="status leave">${e.status}</span></c:otherwise>
                                </c:choose>
                            </td>
                            <td>
                                <div class="action-buttons">
                                    <a href="find-update-employee?employeeId=${e.employeeId}" class="action-btn update-btn">Update</a>
                                    <a href="delete-employee?employeeId=${e.employeeId}" class="action-btn delete-btn">Delete</a>
                                </div>
                            </td>
                        </tr>
                        </c:forEach>
