...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/css/delete-employee.css">
</head>
<body>
    <nav class="navbar">
        ...
        <ul class="nav-links">
            ...
            <li><a href="delete-employee-nav" class="active">Delete</a></li>
        </ul>
    ...
    <main class="delete-section">
        <div class="page-header">
            <div>
                ...
                <p>Find an employee by ID and remove their record from your workforce database.</p>
            </div>
        </div>
            ...
            <div class="delete-card">
                ...
                <form action="find-delete-employee" method="post">
                    <div class="form-group">
                        ...
                        <input type="number" id="employeeId" name="employeeId" placeholder="Enter Employee ID" min="1" required>
                    </div>
