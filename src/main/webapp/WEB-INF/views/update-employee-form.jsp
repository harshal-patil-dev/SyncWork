...
<link rel="stylesheet" type="text/css"
	href="${pageContext.request.contextPath}/css/update-employee-form.css">
</head>
<body>
	...
	<main class="update-section">
		<div class="page-header">
			...
			<p>Update the employee information and keep your workforce
			...
			<div class="update-card">
				...
				<form action="update-employee" method="post">
					...
					<div class="employee-id-box">
						<span>Employee ID</span><strong>#${employee.employeeId}</strong>
					</div>
					<div class="form-grid">
